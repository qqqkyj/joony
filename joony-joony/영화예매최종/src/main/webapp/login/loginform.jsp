      ...
      <table style="width: 500px; margin-top: 1%;">
         ...
         <tr>
          ...
          <script type="text/javascript">
              var naver_id_login = new naver_id_login("cOzHuKVMK_K9_kRKGF4L", "http://localhost:8080/영화예매최종/login/callback.jsp");
              var state = naver_id_login.getUniqState();
              naver_id_login.setButton("green", 3,50);
              naver_id_login.setDomain("http://localhost:8080/영화예매최종/login/callback.jsp");
