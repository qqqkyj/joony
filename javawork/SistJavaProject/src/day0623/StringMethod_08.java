...
public class StringMethod_08 {
	...
	public static void main(String[] args) {
		...
		System.out.println("str2의 앞뒤 공백제거후 길이: "+str2.trim().length());//공백제거 메소드
		System.out.println("*"+str2+"*");
		System.out.println("*"+str2.trim()+"*");//but 글자사이의 공백까진 제거 불가
		
		//indexof
		System.out.println("str1에서 H의 인덱스: "+str1.indexOf('H'));
		System.out.println("str1에서 D의 인덱스: "+str1.indexOf('D'));
		System.out.println("str1에서 N의 인덱스: "+str1.indexOf('N'));
		...
		String b3 = String.valueOf(100);//int==>String으로 바뀜
		String b4 = String.valueOf(12.6);//double==>String으로 바뀜
