...
import boot.data.Dto.StoreDTO;
import boot.data.service.ChatService;
import boot.data.service.ChatServiceInter;
...
public class ChatController {
	...
	public String chatRoom(@RequestParam String other_store_nickname,
		...
		String one_store_nickname = "user1";
		String one_store_img = "user1img";

		//상대방
		//StoreDTO two_storeDTO = storeService.getMember(other_store_nickname);
		String two_mem_id = "user2";
		String two_store_nickname = other_store_nickname;
		String two_store_img = "user2img";
